...
The navigation structure has been simplified to focus on the core workflows:

- Removed standalone `/runs` route
- Removed "Test Cases" navigation link
- Updated all back links to point to `/suite_runs`
- Two primary routes: Dashboard and Test Runs
...
│   ├── TestRunDetailPage/
│   │   └── TestRunDetailPage.tsx              [Modified] - Visual design
│   └── TestDetailPage/
│       └── TestDetailPage.tsx                 [Modified] - Color coding
```
